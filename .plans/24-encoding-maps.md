...
- [25-encoding-interfaces.md](25-encoding-interfaces.md) — `Type` domain; map key comparability
  checks emit `isComparable(k, kType)` using the `Type` domain generated by the interface encoding
